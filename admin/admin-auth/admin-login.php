...
<head>
  ...
  <style>
    ...
    .blur-background {
      right: 0;
      background-image: url('../../assets/image/pexels-cottonbro-6651191.jpg');
...
<!--This is a property of PLSP-CCST BSIT-3B SY 2024-2025 -->
      ...
      <div class="ms-5 form-signin  mt-5 pt-5">
        <!-- Sign In Form -->
        <form class="mb-5" id="signInForm" action="../admin-auth/login.php" method="POST" style="background:none;">
          ...
          <h1 class="h3 mb-4 fw-normal text-dark text-center">Admin Sign in</h1>
